...
function getExtraMysteryBonuses() {
    const bonuses = [
        ...
        { id: "magnet", icon: "🧲", kind: "Pickup reach", name: "Magnetic pockets", description: "Collect hay and other pickups from 25 pixels farther away.",
        ...
        { id: "armor", icon: "◈", kind: "Defense", name: "Barkskin", description: "Take about 9% less damage with the first copy. Repeated copies strengthen your armor with smaller gains.",
        ...
        { id: "slowAura", icon: "❄", kind: "Crowd control", name: "Frost garden", description: "Enemies within 140 pixels move about 13% slower. Half strength against bosses; copies strengthen the slow.",
        ...
        { id: "freezeGift", icon: "⌛", kind: "Immediate protection", name: "Stolen seconds", description: "Freeze ordinary enemies and map movement for 4 seconds without spending the ability cooldown. Bosses are immune.",
        ...
        { id: "basicPower", icon: "✴", kind: "Basic attack", name: "Heavy kernels", description: "Add 1 damage to every basic attack.",
        ...
        { id: "levelHealing", icon: "🌿", kind: "Recovery", name: "Renewal", description: "Restore 8 HP whenever you gain a character level. Repeated copies add another 8 HP.",
        ...
        { id: "heartwood", icon: "♥", kind: "Health & defense", name: "Heartwood", description: "Gain 10 maximum HP, restore 10 HP and add 0.05 armor.",
